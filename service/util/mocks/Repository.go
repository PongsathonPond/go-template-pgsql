...
// DeleteMany provides a mock function with given fields: ctx, filters
func (_m *Repository) DeleteMany(ctx context.Context, filters []string) error {
	ret := _m.Called(ctx, filters)
...
// UpdateBson provides a mock function with given fields: ctx, filters, ent
func (_m *Repository) UpdateBson(ctx context.Context, filters []string, ent primitive.D) error {
	ret := _m.Called(ctx, filters, ent)
