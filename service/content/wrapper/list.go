...
func (wrp *Wrapper) List(ctx context.Context, opt *domain.PageOption) (total int, list []*inout.ContentView, err error) {
	sp, ctx := opentracing.StartSpanFromContext(ctx, "service.content.List")
	defer sp.Finish()
