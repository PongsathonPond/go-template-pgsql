...
var MsgData = map[string]language{
	...
	"bad_request":         {TH: "คำร้องขอไม่ถูกต้อง", EN: "Bad request"},
...
func MsgBadRequest(c *gin.Context) string {
	return get(c, "bad_request")
}
...
func MsgLoginSuccess(c *gin.Context) string {
	return get(c, "login_success")
}

func MsgLogoutSuccess(c *gin.Context) string {
	return get(c, "logout_success")
}
