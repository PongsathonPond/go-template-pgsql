...
// @Param        filters          query     []string  false  "Condition for roles retrieval, ex. `name:eq:John` | `name:like:smith`"
// @Param        sorts            query     []string  false  "Sort for roles data, ex. `created_at:asc`"
// @Success      200              {object}  view.SuccessPaginatorResp{data=view.dataListWithOption{lists=[]inout.RolesListView}}
